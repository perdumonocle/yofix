...
fn исправить_срез(mut исправлено: &mut String, mut последнее_исправление: &mut usize, источник: &str, начало_среза: usize, длина_среза: usize, исправления: Исправления, настройки: &Настройки) {
    // Копирование из источников до начала слова
    let добавок = &источник[*последнее_исправление .. начало_среза];
    println!("Добавок: {}", &добавок);
    исправлено.push_str(&добавок);
